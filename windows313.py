...
print('''\033[1;32;40m \n
 _         _                                ____      _
| |    ___| |__   __ _ _ __   ___  _ __    / ___|   _| |__   ___ _ __
| |   / _ \ '_ \ / _` | '_ \ / _ \| '_ \  | |  | | | | '_ \ / _ \ '__|
| |__|  __/ |_) | (_| | | | | (_) | | | | | |__| |_| | |_) |  __/ |
|_____\___|_.__/ \__,_|_| |_|\___/|_| |_|  \____\__, |_.__/ \___|_|
                                                |___/
                                                V 4.0
from windows313
''')
print("\033[1;40;31m http://instagram.com/lebanon.cyber/\n")
	...
	while True:
		try:
			...
			change()
		 	...
		 	print('\windows313 tools is closed ')
		 	quit()
